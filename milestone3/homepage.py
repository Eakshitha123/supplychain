...
class InventoryManagementApp:
    def __init__(self, root):
        ...
        # Set Cotton-Themed Background Image
        self.bg_image = Image.open("image.png")  # Replace with your cotton-themed background image path
        ...
        self.title_label = tk.Label(self.root, text="Cotton Product Inventory Management", font=("Helvetica", 16, "bold"), bg="#4CAF50", fg="white", padx=20, pady=10)
